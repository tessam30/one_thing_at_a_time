...
v_c + v_l + v_h +
  ...
  plot_annotation(
    title = glue('{metadata$curr_pd} PMTCT CASCADE Zambia'),
    ...
    caption = glue('Mirrors the USAID PMB Quarterly Review Dashboard
        ...
        Source: {metadata$curr_pd} PSNUxIM Genie')) & 
      si_style_ygrid() & 
  theme(plot.subtitle = element_markdown(),
        strip.text = element_blank(),
        legend.position = "none")

si_save(glue("Graphics/{metadata$curr_pd}_ZMB_PMTCT-Cascade.svg"))    
